...
export default function CreateAccountSection({ onNextStep, isActive }: Props) {
    ...
    return (
        <section
            className={cls(
                'flex-none flex flex-col items-center px-24 w-screen h-screen',
        ...
        >
            ...
            >
                <p className="text-20 font-bold mt-96 text-center">
                    1. 당신을 증명할
                </p>
            ...
            <form className="flex flex-col gap-y-4 animate-fadeIn opacity-0 mt-96">
                <div
                    className={cls(
                        'relative text-base flex items-center animate-fadeIn opacity-0 px-2',
                ...
                >
                    <input
                        ...
                        type="text"
                    />
                    <label className="absolute right-0 rounded-12 border border-secondary px-4 text-xs">
                        testnet
                    </label>
                </div>
                <div className="flex flex-col w-full gap-y-4">
                    <button
                        ...
                        className="flex items-center justify-center w-full py-2 bg-secondary text-sm text-white rounded-10 opacity-0 animate-fadeIn"
